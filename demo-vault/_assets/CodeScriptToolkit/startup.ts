...
// plugin's demo vault does its own startup setup. Here it installs the one plugin Custom
// Attachment Location cannot run without, then opens the landing note.
...
// Custom Attachment Location declares it as a dependency and loads nothing until it is there.
